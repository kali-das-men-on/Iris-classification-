...
The project uses 4 features - sepal_length, sepal_width, petal_length, petal_width to classify the species of the iris flower (whether it is Setosa, Versicolor, or Virginica) and walks through the full machine learning pipeline, including data preprocessing, model training, hyperparameter tuning, evaluation, and interpretation.
